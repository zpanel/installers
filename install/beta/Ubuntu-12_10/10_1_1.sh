...
# OS VERSION: Ubuntu Server 12.10.x
# AUTHOR: Lewis Cowles (CODESIGN2, Minor Modification of existing 12.04 LTS script)
# NOTES: UPDATED DPKG TEST, SEEMS WRONG WHEN READING COMMENTS, PERHAPS THE OP HAD NO CLUE WHAT THEY WERE WRITING...
# ARCH: x32_64
...
# We expect a clean OS so no apache/mySQL/bind/postfix/php! #weird seems to install just fine with these
if dpkg -s php5 apache2 mysql-server dovecot-common postfix bind9; then
